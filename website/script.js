...
(function () {
  ...
  const i18n = {
    en: {
      ...
      installTitle: 'Get started today.',
      installDesc: 'Direct binaries are coming soon. Use Homebrew or source build for now.',
      installBrew: 'Homebrew',
      installBrewDesc: 'macOS & Linux',
      installCargo: 'Cargo',
      installCargoDesc: 'Build from source',
      installDirect: 'Direct Download',
      installDirectDesc: 'Coming soon',
    ...
    zh: {
      ...
      installLabel: '快速开始',
      installTitle: '现在就开始。',
      installDesc: '直接下载即将提供，当前可用 Homebrew 或源码构建。',
      installBrew: 'Homebrew',
      installBrewDesc: 'macOS & Linux',
      installCargo: 'Cargo',
      installCargoDesc: '从源码构建',
      installDirect: '直接下载',
      installDirectDesc: '即将提供',
      footerDocs: '文档',
      footerRoadmap: '路线图',
      footerLicense: '许可证',
    },
